...
class ButtonBrowse(wx.BitmapButton):
    def __init__(self, parent):
        wx.BitmapButton.__init__(self, parent, ID_ANY, wx.Bitmap(u'{}/bitmaps/browse32.png'.format(PATH_app)),
                style=wx.NO_BORDER)
        self.SetToolTip(wx.ToolTip(GT(u'Browse')))

class ButtonBrowse64(wx.BitmapButton):
    def __init__(self, parent):
        wx.BitmapButton.__init__(self, parent, ID_ANY, wx.Bitmap(u'{}/bitmaps/browse64.png'.format(PATH_app)),
                style=wx.NO_BORDER)
        self.SetToolTip(wx.ToolTip(GT(u'Browse')))

class ButtonBuild(wx.BitmapButton):
    def __init__(self, parent, ):
        wx.BitmapButton.__init__(self, parent, ID_ANY, wx.Bitmap(u'{}/bitmaps/build32.png'.format(PATH_app)),
                style=wx.NO_BORDER)
        self.SetToolTip(wx.ToolTip(GT(u'Build')))

class ButtonBuild64(wx.BitmapButton):
    def __init__(self, parent):
        wx.BitmapButton.__init__(self, parent, ID_ANY, wx.Bitmap(u'{}/bitmaps/build64.png'.format(PATH_app)),
                style=wx.NO_BORDER)
        self.SetToolTip(wx.ToolTip(GT(u'Build')))
...
class ButtonDel(wx.BitmapButton):
    def __init__(self, parent):
        wx.BitmapButton.__init__(self, parent, WXK_DELETE, wx.Bitmap(u'{}/bitmaps/del32.png'.format(PATH_app)),
                style=wx.NO_BORDER)
        self.SetToolTip(wx.ToolTip(GT(u'Remove')))

class ButtonImport(wx.BitmapButton):
    def __init__(self, parent):
        wx.BitmapButton.__init__(self, parent, ID_ANY, wx.Bitmap(u'{}/bitmaps/import32.png'.format(PATH_app)),
                style=wx.NO_BORDER)
        self.SetToolTip(wx.ToolTip(GT(u'Import')))

class ButtonNext(wx.BitmapButton):
    def __init__(self, parent):
        wx.BitmapButton.__init__(self, parent, ID_ANY, wx.Bitmap(u'{}/bitmaps/next32.png'.format(PATH_app)),
                style=wx.NO_BORDER)
        self.SetToolTip(wx.ToolTip(GT(u'Next')))

class ButtonPipe(wx.BitmapButton):
    def __init__(self, parent):
        wx.BitmapButton.__init__(self, parent, ID_ANY, wx.Bitmap(u'{}/bitmaps/pipe32.png'.format(PATH_app)),
                style=wx.NO_BORDER)
        self.SetToolTip(wx.ToolTip(GT(u'Append')))

class ButtonPrev(wx.BitmapButton):
    def __init__(self, parent):
        wx.BitmapButton.__init__(self, parent, ID_ANY, wx.Bitmap(u'{}/bitmaps/prev32.png'.format(PATH_app)),
                style=wx.NO_BORDER)
