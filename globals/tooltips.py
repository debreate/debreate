...
TT_changelog = {
	...
	"target": GT("Target to install changelog file"),
...
TT_launchers = {
	...
	"btn add": GT("Add a new launcher"),
	"btn clear": GT("Clear category list"),
	...
	"chk catcustom": GT("List custom categories first"),
	...
	"btn other": GT("Add a custom field"),
	"btn rm other": GT("Remove selected custom fields"),
}

TT_build = {
	"md5": GT("Creates a checksum for all staged files within the package"),
	"md5_disabled": GT("Install md5sum package for this option"),
	"editctrl": GT("Opens preview of control file for editing before build"),
	"strip": (
